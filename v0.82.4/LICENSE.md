Copyright © 2025-2026 Phoneshift, France. contact@pitchmeld.ing
...
- **The Products**: Pitchmeld provides audio transformation technologies. Here below, transformation technologies, Software Packages, Software Development Toolkits (SDK), Plugins and related Services, Web Services and Websites are refered as the Products.
- **We, us, the Company, Phoneshift**: The legal owner and rights holders of the Products, as a sole proprietorship. https://pitchmeld.ing/en/legal/legal-notice
- **Website**: Any of the main or sub domain of pitchmeld.ing
- **You or your**: The owner of a Pitchmeld license and an Account on our Website. This license allows to use parts or all of our Products.
- **Account**: A billing account, a digital entity on our Website that allows you to manage your subscription, payment and other elements related to your license.
...
- **Users**: Any entity, linked to an Account, that makes use of a license, a physical person, an automated service, a bot, etc.
...
- **Documentation**: The documentation of the Products. Accessible online at: https://docs.pitchmeld.ing
- **Terms**: The terms of this license. Available within each copy of the Software Package or SDK provided to you. The latest copy of these terms is accessible online at: https://docs.pitchmeld.ing/latest/license.html
- **Personal Data**: Any information that relates to an identified or identifiable natural person, as per the [GDPR definition](https://commission.europa.eu/law/law-topic/data-protection/data-protection-explained_en).

## 1.2 Agreement

When you use one of our Products, you are agreeing to the latest version of the General and Specific Terms described herein.
...
The resale or distribution of any portion of the Products, or the Products in their entirety, whether in their original form or with only minimal modifications or added value, is strictly prohibited.
...
When using our Products, you must ensure that the Users making use of your Account comply with all applicable laws and regulations and respect the Terms of this License.
...
This provision also applies in circumstances where a third party gains unauthorized access to, or circumvents, restrictions or limitations intended solely for the benefit of the Purchase Agreement, Offer, Quote, Account, Tier granted to you.


## 1.6 Data Commitments

This section sets forth the Company's contractual commitments regarding your data.
Additional information regarding data processing practices is made available in our Privacy Policy, published on our Website, in compliance with applicable data protection regulations. The content and accessibility of the Privacy Policy are provided for informational and regulatory purposes only and do not constitute contractual obligations.

### 1.6.1 Data Collected

The Company collects and retains only the data strictly necessary to provide the Products, process billing, and comply with applicable legal obligations. The categories of data collected are:

- **Billing data**: Name, address, payment records, and past invoices required for service delivery and tax compliance.
- **Billing-related usage metrics**: Data necessary to track consumption against your subscribed quota for invoicing purposes.
- **Anonymized usage statistics**: Fully anonymized usage metrics collected for product improvement, issue detection, and aggregate analytics. These metrics contain no personal data and cannot be linked back to any individual user or account.

### 1.6.2 Audio Data Guarantee

All audio signals are processed exclusively on the local device upon which the Products are installed or deployed. The Company does not transmit, store, or gain access to any audio signals or information derived from audio content at any time. You retain full ownership and control over all audio material processed through the Products.

### 1.6.3 No Sale of Personal Data

The Company will not sell, rent, or exchange your personal data to any third party for any purpose.

### 1.6.4 Marketing Consent

The Company will not use your name or your company's name in public marketing statements, press releases, or promotional materials without your prior written permission.

### 1.6.5 Data Retention Commitment

The Company will retain your personal data only for as long as necessary to fulfill the purposes for which it was collected, or as required by applicable law (including tax and accounting obligations). Upon expiration of the applicable retention period, the data will be permanently deleted. The Company may retain data necessary for the establishment, exercise, or defense of legal claims.

### 1.6.6 Data Transfer and Storage Consent

Our web Services are operated in various countries (see Privacy Policy). By using our Products and Websites and/or providing us with your personal information, you consent to the transfer and storage of your data through and in those countries, as well as any transfers to third-party subprocessors used for billing and infrastructure.

### 1.6.7 Data Rights

You may exercise your data protection rights, including access, rectification, erasure, portability, restriction of processing, and objection, at any time by contacting legal@pitchmeld.ing. The Company will respond to valid requests within the timeframes required by applicable law.


## 1.7 Security

The Company commits to implementing appropriate technical and organizational measures to protect your data.

### 1.7.1 Encryption in Transit

All communications between your device and the Company's servers use Hypertext Transfer Protocol Secure (HTTPS).

### 1.7.2 Credential Security

All passwords and API keys are stored exclusively in hashed format and are never retained in plain text. The Company cannot recover lost or forgotten passwords or access keys.

### 1.7.3 Software Maintenance

The Company endeavors to keep the Websites and Products updated with the latest security patches and cryptographic libraries. For Products installed or deployed by you, it is your responsibility to apply updates to your systems in a timely manner.


## 1.8 Abuse, misuse and unacceptable use
...
- Use the Products in a manner that does not respect Copyright laws.
- Use the Products in a manner that abuse someone's identity.
- Use the Products for serving violent or harassing content (doxxing, revenge pornography).
- Use the Products in a manner inconsistent with any applicable laws or regulations, including international laws.

This isn't an exhaustive list. In any doubt, feel free to email us at legal@pitchmeld.ing
...
### 1.8.2 Prohibition on Competing Services

You are strictly prohibited from creating, operating, or offering a competing service that makes use of the Products. For example, this implies that you cannot create an API cloud service that would serve any or all of the Products' functionalities.

You remain free to build applications, tools, or products that incorporate the Products for your own use or for sale to others, as long as such applications do not constitute a competing service to the Company's offerings.
...
For any support inquiries or questions regarding our Products, you can contact the Company at support@pitchmeld.ing

The Company will make reasonable efforts to address user concerns in a timely manner.

## 1.10 Issues handling

For any matters, including but not limited to:
- Billing
- Account management
- Non-technical complaints and grievances
- Security concerns
- Report for abuse, misuse and unacceptable use

All such matters must be communicated between the concerned user and the Company, exclusively, directly and privately, through support@pitchmeld.ing or legal@pitchmeld.ing or through other designated communication channels.
The Company reserves the right to disregard any complaint or claim that is not substantiated by adequate evidence or supporting documentation.
...
Continued use of one of our Products constitutes acceptance of the last version of the General and Specific Terms.
...
By default, an Account is owned by an individual, not by an organization (a company, an association, etc).
It can, however, be owned by an organisation, as long the organisation is registered in the country of its head office.
...
Suspension means you and any Users making use of API keys from your Account will not be able to use any Product.
...
* Fully anonymized information (see Section 1.6.1).

### 2.1.6 Termination

If you violate any of the Terms, we may terminate your account, without notice and without compensation.

You may Terminate the License at any time through the Cancellation and Deletion process (Sec. 2.1.4 and 2.1.5).
...
### 2.2.1 Waiver of Right of Withdrawal

We request your waiver of Right of Withdrawal for the following two reasons.

A "Testing" tier is provided to the users, which allows enough tests to be performed before buying any subscription.

When you purchase and use our Products, you receive immediate access to the software and its processing capabilities on your local machine.
The audio transformation results are generated directly on your device, not on our servers, they cannot be "canceled" nor "returned" to us.

By buying any of our Products, you expressly acknowledge and agree to waive your right of withdrawal (14-day cooling-off period). EU Directive 2011/83/EU on consumer rights, [Article 16(m)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32011L0083#d1e211-109-1)

By completing your purchase, you confirm that you understand and accept that:
- You are being provided with immediate access to the digital content, the software and any audio transformation results.
- The performance of the Products has begun with your explicit consent
- Your statutory right of withdrawal ends when the purchase is completed
- The purchase is final and no refunds shall be available

### 2.2.2 One-off payments

By purchasing through a One-off payment, the provisions of this Section shall be binding upon you.

You expressly acknowledge and agree to waive your right as explained in Section 2.2.1.

No refunds shall be available for purchases made through One-off payments.

### 2.2.3 Periodic payments for Subscriber Accounts
...
When a quantity limit is imposed for a specified time period (e.g., 1 hour per month), the following provisions shall apply:

* The specified quantity may be consumed within the applicable time period.
* The quota shall reset on the anniversary date of the Account, corresponding to the designated time period (daily, weekly, or monthly, as applicable).
* Quotas are non-cumulative. Unused quota from any given period shall not carry over to subsequent periods. For example, if the monthly quota is 1 hour and such quota remains unconsumed during a given month, no additional quantity shall be granted for the following month.


## 2.3 Free Accounts

Free Accounts are strictly limited to non-commercial use. The following activities require a paid subscription or one-off payment license:

- Use of the Products in any application, service, or product that generates revenue or is offered to customers.
- Use of the Products in any business context, including internal tools, prototypes, or proof-of-concepts intended for commercial evaluation.
