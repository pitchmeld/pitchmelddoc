...
You are strictly prohibited from creating, operating, or offering a competing service that makes use of the Products. For example, this implies that you cannot use the Products to build and operate a service that competes with the Company's own services.
