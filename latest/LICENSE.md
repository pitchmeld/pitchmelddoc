...
- Billing information, ex. name, address.
- Past invoices.
...
This anonymized information is used to drive usage statistics, spot potential issues, and improve our Products.
...
These subprocessors are fully or partly located in the EU, EEA or EFTA:

* Fly.io, Inc.: Infrastructure for Application Programming Interface (API). US company, data transfered through France/EU.
* Supabase, Inc.: Database. US company, data transfered and stored in France/EU.
* Plunk: Transactional mail service. Dutch company, data transfered through Netherland/EU.
* Proton AG / Proton Mail: Email service. Swiss company, data transfered and stored in Switzerland/EFTA.

These subprocessors are fully or partly located in the United States:

* Stripe, Inc. / Lemon Squeezy: Billing service. US company, data transfered and stored in the US.

### 1.6.7 Location of site and data

Our web Services are operated in France. If you are located outside of France, please be aware that any information you provide to us will be transfering through France.
All information will also be stored in France, except for the billing information that are subprocessed by Lemon Squeezy.
We have no control over the locations of transfer and storage used by Lemon Squeezy.
By using our Products and Websites and/or providing us with your personal information, you consent to those transfers and storage.
...
In our infrastructures, all passwords and API keys are stored exclusively in a hashed format and are never retained in plain text.
